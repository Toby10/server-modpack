...
- Convenient Effects – Исправления работы некоторых эффектов
...
- Fluid Void Fading – Жидкости на конце имеют плавный градиент
...
- Subtle Effects – Визуальные эффекты
...
- Ding – Звук колокольчика после успешной загрузки игры
- Dynamic Crosshair – Прицел меняется динамически
- Fast Scrolling – Быстрая прокрутка на `Ctrl`
- Food Effect Tooltip – Отображает эффекты от еды в инвентаре
...
- Mica – Совместимость с темой Windows
...
- FixElytraBug – Исправляет прыжки в туннеле 2 блока высотой
- Hold That Chunk – Дольше хранит чанки в памяти клиента
- I see you over there! – Динамически меняет дальность симуляции
...
- Relaxed Instabreak – Замедляет разрушение блоков при удержании `Shift`
- Remove Rod Blocking – Убирает поплавок удочки, когда тебя тащат
...
- Accessories – Дополнительные слоты снаряжения для аксессуров
